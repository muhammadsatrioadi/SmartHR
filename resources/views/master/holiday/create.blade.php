        ...
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <form method="POST" action="{{ route('holiday.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="kode_libur" value="{{ old('kode_libur') }}"
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_tetap" name="is_tetap"
                                value="1" {{ old('is_tetap', false) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-3">
                        <div class="form-check mb-3">
                            <input type="checkbox" class="form-check-input" id="is_hari_raya" name="is_hari_raya"
                                value="1" {{ old('is_hari_raya', false) ? 'checked' : '' }}>
