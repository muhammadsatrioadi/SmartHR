...
@section('content')
    <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary rounded h-100 p-4">
            <h6 class="mb-4">Tambah Shift Kerja</h6>

            <form method="POST" action="{{ route('workShift.store') }}">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <select name="shift_group_id" class="form-select">
                        ...
                        @foreach ($shiftGroups as $group)
                            <option value="{{ $group->id }}" {{ old('shift_group_id') == $group->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="time" name="jam_mulai_telat" value="{{ old('jam_mulai_telat') }}"
                            class="form-control">
                    </div>
                    <div class="col-md-3 mb-3">
                        <label class="form-label">Masuk Cepat</label>
                        <input type="time" name="jam_masuk_cepat" value="{{ old('jam_masuk_cepat') }}"
                            class="form-control">
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="toleransi_telat_menit"
                        value="{{ old('toleransi_telat_menit', 0) }}" class="form-control">
                </div>

                <div class="form-check mb-3">
                    <input class="form-check-input" type="checkbox" value="1" id="is_aktif" name="is_aktif" checked>
