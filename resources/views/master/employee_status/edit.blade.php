...
@section('content')
    <div class="container-fluid pt-4 px-4">
        <div class="bg-secondary rounded h-100 p-4">
            <h6 class="mb-4">Edit Status Pegawai RS</h6>

            <form method="POST" action="{{ route('employeeStatus.update', $item->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-check mb-3">
                            <input class="form-check-input" type="checkbox" value="1" id="is_payroll" name="is_payroll" {{ old('is_payroll', $item->is_payroll) ? 'checked' : '' }}>
